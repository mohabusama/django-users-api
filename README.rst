...
.. image:: https://img.shields.io/pypi/v/django-users-api.svg
    :target: https://pypi.python.org/pypi/django-users-api/
    :alt: Latest Version
.. image:: https://img.shields.io/pypi/status/django-users-api.svg
    :target: https://pypi.python.org/pypi/django-users-api/
    :alt: Development Status
.. image:: https://img.shields.io/github/license/mohabusama/django-users-api.svg
    :target: https://pypi.python.org/pypi/django-users-api/
    :alt: License
.. image:: https://img.shields.io/pypi/dm/django-users-api.svg
    :target: https://pypi.python.org/pypi//django-users-api/
    :alt: Downloads
